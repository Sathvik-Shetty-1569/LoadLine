...
export const thuBlocks: Block[] = [
  ...sharedWarmup(),
  {
    ...
    tags: ['hypertrophy', 'strength'], focus: 'Quads, glutes',
  },
  {
    ...
    tags: ['hypertrophy', 'balance'], focus: 'Quads, glutes',
  },
  {
    ...
    tags: ['hypertrophy'], focus: 'Quads, glutes',
  },
  {
    ...
    tags: ['hypertrophy'], focus: 'Calves (gastrocnemius)',
  },
  {
    ...
    tags: ['hypertrophy'], focus: 'Calves (soleus)',
  },
  {
    ...
    exerciseA: { name: 'Lying Leg Raises', prescription: '15-20', kind: 'reps', estWorkSec: 13, notes: 'No swinging', tags: ['core'], focus: 'Lower abs, hip flexors' },
    exerciseB: { name: 'Plank', prescription: '30-45 sec', kind: 'hold', holdSec: 37, notes: 'Hold between leg-raise sets', tags: ['core', 'endurance'], focus: 'Deep core, anti-extension' },
  },
  {
    ...
    tags: ['grip', 'core'], focus: 'Grip, traps, trunk stability',
  },
