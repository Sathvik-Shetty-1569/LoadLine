...
export const tueBlocks: Block[] = [
    ...
    tags: ['hypertrophy', 'strength'], focus: 'Lats, upper back, biceps' },
  {
    ...
    tags: ['hypertrophy'], focus: 'Inner chest, triceps',
  },
  {
    ...
    tags: ['hypertrophy'], focus: 'Inner / sternal chest',
  },
  {
  ...
  },
  {
    ...
    exerciseA: { name: 'DB Lateral Raise', prescription: '15-20', kind: 'reps', estWorkSec: 45, notes: '1-sec pause at top', tags: ['hypertrophy'], focus: 'Side delts' },
    exerciseB: { name: 'DB Overhead Triceps Extension', prescription: '15-20', kind: 'reps', estWorkSec: 45, notes: 'Full stretch at bottom', tags: ['hypertrophy'], focus: 'Triceps (long head)' },
  },
  {
  ...
  },
  {
    ...
    tags: ['grip', 'hypertrophy'], focus: 'Forearm flexors + extensors',
  },
